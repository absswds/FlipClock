...
private val labels: Map<String, List<String>> = mapOf(
    ...
    "date_font_size" to listOf("日期字体大小", "Date font size", "日付の文字サイズ", "날짜 글자 크기", "Taille date", "Datum Schriftgröße", "Tamaño de fecha", "Tamanho da data", "Размер даты", "حجم خط التاريخ"),
    "signature_font_size" to listOf("签名字体大小", "Signature font size", "署名の文字サイズ", "서명 글자 크기", "Taille signature", "Signatur Schriftgröße", "Tamaño de firma", "Tamanho da assinatura", "Размер подписи", "حجم خط التوقيع"),
